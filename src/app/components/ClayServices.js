            ...
            <div className="w-full global-padding">
                ...
                <div className="flex flex-col md:flex-row gap-16 md:gap-32">
                    ...
                    >
                        ...
                        >
                            <div>
                                <span className="block text-title md:text-display-s font-normal text-[var(--text-primary)] mb-1 ">24</span>
                                <span className="text-body-m text-[var(--text-secondary)]">Clients</span>
                            </div>
                            <div>
                                <span className="block text-title md:text-display-s font-normal text-[var(--text-primary)] mb-1 mr-">129</span>
                                <span className="text-body-m text-[var(--text-secondary)]">Projects </span>
                            </div>
                            <div>
                        ...
                        <div className="flex flex-col">
                            {SERVICES_LIST.map((service, index) => (
                                ...
                                >
                                    ...
                                    >
                                        <h3 className="text-subtitle-m md:text-[24px]! font-medium text-neutral-900! group-hover:text-gray-600 transition-colors">
                                            {service.title}
                                        </h3>
                                    ...
                                    >
                                        <p className="text-body-m text-[var(--text-secondary)]! pl-2 max-w-2xl mb-4">
                                            {service.description}
                                        </p>
                                        <Link
                                            href={service.href}
                                            className="ml-2 inline-flex items-center gap-2 text-[15px] font-medium text-neutral-900 border-b border-neutral-900 pb-0.5 hover:gap-3 transition-all"
                                        >
                                            Learn More
