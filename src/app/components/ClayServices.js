...
export default function ClayServices() {
  ...
  return (
    <section className="min-h-[80vh] bg-white pt-32 pb-12">
      <div className="mx-auto px-6 max-w-[1280px] relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-y-12">
          ...
          <div className="md:col-span-5 sticky top-32 self-start">
            <h2 className="text-[2rem] md:text-[2.5rem] leading-[1.2] font-medium text-black">
          ...
          <div className="md:col-span-7 w-full flex flex-col justify-start">
            <div className="flex flex-col space-y-6 w-full max-w-[520px] ml-auto mr-0">
              {services.map((service) => (
                ...
                >
                  <div className="flex items-center justify-between gap-6 py-4 border-b border-transparent transition-colors duration-300">
                    <h3 className={`text-2xl md:text-3xl font-medium transition-colors duration-200 ${activeService === service.slug ? 'text-black' : 'text-gray-400 group-hover:text-black'}`}>
                      {service.name}
                    </h3>
                    <motion.span 
                      animate={{ rotate: activeService === service.slug ? 180 : 0 }}
                      className={`text-2xl transition-colors duration-200 flex-shrink-0 ${activeService === service.slug ? 'text-black' : 'text-gray-300 group-hover:text-black'}`}
                    >
                    ...
                    {(activeService === service.slug) && (
                      ...
                      >
                        <div className="pt-4 pb-8 flex flex-col items-start text-left">
                            <p className="text-lg leading-relaxed text-gray-600 max-w-lg mb-6">
                                {service.description}
                            </p>
      ...
      <div className="w-full mt-32 overflow-hidden border-t border-gray-100 pt-8">
