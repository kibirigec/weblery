...
export default function DigitalMarketingPage() {
  return (
    <main>
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-16 bg-gradient-to-br from-yellow-50 to-yellow-100">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-yellow-100 rounded-xl mb-6 shadow-lg border border-yellow-200">
              <svg className="w-10 h-10 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" />
              </svg>
            </div>
            <h1 className="text-4xl sm:text-5xl font-bold mb-6 text-gray-900">Digital Marketing</h1>
      ...
      <section className="section">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6 text-gray-900">Strategic Digital Growth</h2>
            ...
            <div className="bg-yellow-50 p-8 rounded-xl border border-yellow-100">
              <h3 className="text-2xl font-bold mb-6 text-gray-900">Marketing Channels</h3>
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-4 bg-white rounded-lg border border-yellow-200 hover:border-yellow-300 transition-colors">
                  <h4 className="font-semibold text-gray-800">Search Marketing</h4>
                  <p className="text-sm text-gray-600">Google Ads, SEO</p>
                </div>
                <div className="text-center p-4 bg-white rounded-lg border border-yellow-200 hover:border-yellow-300 transition-colors">
                ...
                <div className="text-center p-4 bg-white rounded-lg border border-yellow-200 hover:border-yellow-300 transition-colors">
                  ...
                  <p className="text-sm text-gray-600">Mailchimp, ConvertKit</p>
                </div>
                <div className="text-center p-4 bg-white rounded-lg border border-yellow-200 hover:border-yellow-300 transition-colors">
                  <h4 className="font-semibold text-gray-800">Analytics</h4>
                  <p className="text-sm text-gray-600">Google Analytics, Data Studio</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section bg-yellow-50">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Marketing Services</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl border border-yellow-200 hover:border-yellow-300 transition-all duration-300 hover:shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900">PPC Advertising</h3>
            ...
            <div className="bg-white p-6 rounded-xl border border-yellow-200 hover:border-yellow-300 transition-all duration-300 hover:shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Social Media Marketing</h3>
